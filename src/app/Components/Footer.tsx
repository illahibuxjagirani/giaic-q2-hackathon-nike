...
{/* footer div */}
<div className="px-10 md:px-16 flex md:flex-row flex-col justify-center items-center py-5 relative">
  

{/* Latest offers */}
<div className=" bg-black flex md:flex-row flex-col items-center justify-between mx-5 md:mx-16 py-[36px] md:px-[64px] px-5 gap-8 rounded-xl absolute lg:-top-[150px] md:-top-[150px] sm:-top-[250px] -top-[270px]">
  
  <div>
<h1 className="text-white sm:text-[40px] text-[35px] font-extrabold lg:w-[65%] leading-[40px]">STAY UPTO DATE ABOUT OUR LATEST OFFERS</h1>
  </div>
